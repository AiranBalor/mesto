...
const removeCardFormServer = function (card) {
  return () => {
    apiInstance
      .deleteCardFromServer(card.getCardId())
      .then(card.handleDeleteCardFromDOM(), popupDeleteCardConfirm.close())
      .catch((err) => {
        console.log(`Ошибка - ${err.status}`);
      });
  };
...
const popupUserProfile = new PopupWithForm({
  ...
  handleFormSubmit: (data) => {
    ...
    apiInstance
      ...
      .finally(popupUserProfile.renderLoading(false), popupUserProfile.close());
  },
});
...
const popupAvatar = new PopupWithForm({
  ...
  handleFormSubmit: (data) => {
    ...
    apiInstance
      ...
      .finally(popupAvatar.renderLoading(false), popupAvatar.close());
  },
});
...
const popupAddCard = new PopupWithForm({
  ...
  handleFormSubmit: (data) => {
    ...
    apiInstance
      ...
      .finally(popupAddCard.renderLoading(false), popupAddCard.close());
  },
});

popupAddCard.setEventListeners();

const popupDeleteCardConfirm = new PopupConfirm(
  popupCardDelete,
  removeCardFormServer
);
